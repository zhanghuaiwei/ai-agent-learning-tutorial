...
这是一套面向有 4 年前端开发经验、具备少量 Spring Boot CRUD 与 Python 语法基础的转型教程。目标是在 2027 年 2 月中旬前形成独立开发企业级 Agent 应用的能力，并于 2027 年 2 月底至 3 月初开始投递和面试。
...
| --- | --- |
| 每周时间 | 15 小时 |
| 核心周期 | 2026-08-31 至 2027-02-14，共 24 周 |
| 投递窗口 | 2027-02-15 至 2027-02-28 |
| 面试窗口 | 2027 年 3 月初 |
| 目标城市 | 西安 |
| Agent 主语言 | Python |
...
- 前 18 周只使用 Python 完成 Agent 原理、RAG、LangGraph 与评测，保证核心能力不被双栈稀释；
- Python Agent 服务负责模型访问、RAG、工具编排、状态、评测和 Agent 安全；
- 第 21 周在核心验收通过的前提下加入 Spring Boot 业务服务；
